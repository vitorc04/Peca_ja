                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 20,),
                        placesWidget("food1", "Sugoi Kansha"),
                        SizedBox(height: 20,),
                        Row(
                          crossAxisAlignment: CrossAxisAlignment.end,
                          children: [
                            Text("Pratos", style: TextStyle(
                                fontSize: 22,
                                fontWeight: FontWeight.w700
                            ),),
                            SizedBox(width: 10,),
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              dishWidget("sushi", "Rolo Sushi", "5 Sushis Servidos"),
                              dishWidget("suchi2", "Prato Sushi", "5 Sushis Servidos"),
                              dishWidget("sushi3", "Sushi Box", "5 Sushis Servidos"),
                              dishWidget("sushi4", "Sushi Rei", "5 Sushis Servidos"),
                            ],
                          ),
                        )
                      ],
      ...
      children: [
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Text("Peça Já!", style: TextStyle(
                color: Colors.white,
                fontSize: 12,
                fontWeight: FontWeight.w700
            ),),
